...
/obj/item/organ/zombie_infection/proc/zombify()
	...
	to_chat(owner, span_alertalien("I am now a zombie! Do not seek to be cured, do not help any non-zombies in any way, do not harm my zombie brethren and spread the disease by killing others. You are a creature of hunger and violence."))
