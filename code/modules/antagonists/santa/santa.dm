...
/datum/antagonist/santa/greet()
	. = ..()
	to_chat(owner, span_boldannounce("I am Santa! Your objective is to bring joy to the people on this station. You have a magical bag, which generates presents as long as you have it! You can examine the presents to take a peek inside, to make sure that you give the right gift to the right person."))
