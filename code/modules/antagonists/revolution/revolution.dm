...
/datum/antagonist/rev/greet()
	to_chat(owner, span_danger("I am now a revolutionary! Help your cause. Do not harm your fellow freedom fighters. You can identify your comrades by the red \"R\" icons, and your leaders by the blue \"R\" icons. Help them kill the heads to win the revolution!"))
...
/datum/antagonist/rev/head/admin_add(datum/mind/new_owner,mob/admin)
	...
	to_chat(new_owner.current, span_danger("I am a member of the revolutionaries' leadership now!"))
