...
/datum/action/innate/seek_master/Activate()
	...
	if(tracking)
		tracking = FALSE
		the_construct.seeking = FALSE
		to_chat(the_construct, span_cultitalic("I am no longer tracking your master."))
		return
	else
		tracking = TRUE
		the_construct.seeking = TRUE
		to_chat(the_construct, span_cultitalic("I am now tracking your master."))
...
/datum/action/innate/seek_prey/Activate()
	...
	if(the_construct.seeking)
		...
		button_icon_state = "cult_mark"
		the_construct.seeking = FALSE
		to_chat(the_construct, span_cultitalic("I am now tracking Nar'Sie, return to reap the harvest!"))
		return
	else
		if(LAZYLEN(GLOB.cult_narsie.souls_needed))
			...
			to_chat(the_construct, span_cultitalic("I am now tracking your prey, [real_target.real_name] - harvest [real_target.p_them()]!"))
		else
