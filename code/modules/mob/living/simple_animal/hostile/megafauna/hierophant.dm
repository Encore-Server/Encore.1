...
/datum/action/innate/megafauna_attack/blink
	...
	chosen_message = span_colossus("I am now blinking to my target.")
	chosen_attack_num = 1
...
/datum/action/innate/megafauna_attack/chaser_swarm
	...
	chosen_message = span_colossus("I am firing a chaser swarm at my target.")
	chosen_attack_num = 2
...
/datum/action/innate/megafauna_attack/cross_blasts
	...
	chosen_message = span_colossus("I am now firing cross blasts at my target.")
	chosen_attack_num = 3
...
/datum/action/innate/megafauna_attack/blink_spam
	...
	chosen_message = span_colossus("I am now repeatedly blinking at my target.")
	chosen_attack_num = 4
