...
/datum/action/innate/megafauna_attack/fire_cone
	...
	chosen_message = span_colossus("I am now shooting fire at your target.")
	chosen_attack_num = 1
...
/datum/action/innate/megafauna_attack/fire_cone_meteors
	...
	chosen_message = span_colossus("I am now shooting fire at your target and raining fire around you.")
	chosen_attack_num = 2
...
/datum/action/innate/megafauna_attack/mass_fire
	...
	button_icon_state = "1"
	chosen_message = span_colossus("I am now shooting mass fire at your target.")
	chosen_attack_num = 3
...
/datum/action/innate/megafauna_attack/lava_swoop
	...
	chosen_message = span_colossus("I am now swooping and raining lava at your target.")
	chosen_attack_num = 4
