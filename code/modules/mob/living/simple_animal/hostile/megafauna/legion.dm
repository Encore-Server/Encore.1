...
/datum/action/innate/megafauna_attack/create_skull
	...
	chosen_message = span_colossus("I am now creating legion skulls.")
	chosen_attack_num = 1
...
/datum/action/innate/megafauna_attack/charge_target
	...
	chosen_message = span_colossus("I am now charging at your target.")
	chosen_attack_num = 2
...
/datum/action/innate/megafauna_attack/create_turrets
	...
	chosen_message = span_colossus("I am now creating legion sentinels.")
	chosen_attack_num = 3
