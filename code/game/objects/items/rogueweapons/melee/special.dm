...
/obj/item/rogueweapon/katar/silver
	force = 18
	name = "silver katar"
	desc = "A silver blade that sits above the user's fist. Commonly used by those proficient at unarmed fighting. This one is engraved with Katholikos imagery along the blade."
	icon_state = "silver_katar"
