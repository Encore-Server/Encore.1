/datum/patron/all_aspect
	...
	t0 = /obj/effect/proc_holder/spell/invoked/sacred_flame_rogue // Divine fire. Light the heretics' pyre. Nobody is able to get this high on All-Aspect anyway so t2 and beyond are kinda moot. But something for future plans maybe.
	t1 = /obj/effect/proc_holder/spell/invoked/push_spell // Dark Souls wrath of the gods
	t2 = /obj/effect/proc_holder/spell/invoked/blade_burst // Be attacked by unaspected holy energy or something. All-Aspect is the balance, so it being amorphous energy instead of any one element seems neat.
	t3 = /obj/effect/proc_holder/spell/invoked/counterspell // Counterspell, for nullifying on heretical magic.
